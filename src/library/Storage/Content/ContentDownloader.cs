    ...
    internal class ContentDownloader
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                using (var updateRequest = new HttpRequestMessage { RequestUri = new Uri(url), Method = HttpMethod.Get })
                {
        ...
        private long GetFileSizeOnServer(HttpClient client, string url, CancellationToken cancellationToken)
        {
